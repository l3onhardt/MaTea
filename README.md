...
- 一键安装 `VLESS + REALITY`
- 自动优选 Reality SNI：按地区候选库检测 TLS1.3、X25519、H2、证书匹配和跳转情况，并对热门/CDN 站点加惩罚
...
SNI 会自动从地区候选和通用候选中严格检测。脚本会优先避开不满足 TLS1.3、X25519、H2、证书匹配的站点，并对 Cloudflare、Microsoft、Apple 等过热目标加分数惩罚。
